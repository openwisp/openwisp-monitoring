    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', model_utils.fields.AutoCreatedField(default=django.utils.timezone.now, editable=False, verbose_name='created')),
                ('modified', model_utils.fields.AutoLastModifiedField(default=django.utils.timezone.now, editable=False, verbose_name='modified')),
                ('health', models.CharField(choices=[('ok', 'ok'), ('problem', 'problem')], default='ok', max_length=8)),
                ('name', models.CharField(max_length=64)),
                ('description', models.TextField(blank=True)),
                ('key', models.SlugField(blank=True, help_text='leave blank to determine automatically', max_length=64)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', model_utils.fields.AutoCreatedField(default=django.utils.timezone.now, editable=False, verbose_name='created')),
                ('modified', model_utils.fields.AutoLastModifiedField(default=django.utils.timezone.now, editable=False, verbose_name='modified')),
                ('operator', models.CharField(choices=[('<', 'less than'), ('>', 'greater than')], max_length=1)),
                ('value', models.IntegerField(help_text='threshold value')),
                ('seconds', models.PositiveIntegerField(default=0, help_text='for how long should the threshold value be crossed before triggering an alert? The maximum allowed is 604800 seconds (7 days)', validators=[django.core.validators.MaxValueValidator(604800)])),
                ('metric', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='monitoring.Metric')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='graph',
            name='metric',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='monitoring.Metric'),
        ),
