...
class BaseTestGraphs(object):
    ...
    def test_is_aggregate_bug(self):
        m = self._create_object_metric(name='summary_avg')
        g = self.graph_model(metric=m, configuration='dummy')
    ...
    def test_is_aggregate_fields_function(self):
        ...
        g = self.graph_model(metric=m, configuration='uptime')
    ...
    def test_query_histogram(self):
        ...
        g = self.graph_model(metric=m, configuration='histogram')
        g.full_clean()
        g.save()
