...
class TestDeviceApi(AuthenticationMixin, TestGeoMixin, DeviceMonitoringTestCase):
    ...
    def test_unhealthy_metrics_endpoint_ok_device(self):
        ...
        url = reverse("monitoring:api_device_unhealthy_metrics", args=[device.pk])
    ...
    def test_unhealthy_metrics_endpoint_wrong_device(self):
        url = reverse(
            "monitoring:api_device_unhealthy_metrics",
    ...
    def test_unhealthy_metrics_endpoint_multitenancy(self):
        ...
        org1_url = reverse(
            "monitoring:api_device_unhealthy_metrics", args=[org1_device.pk]
        )
        ...
        org2_url = reverse(
            "monitoring:api_device_unhealthy_metrics", args=[org2_device.pk]
        )
