...
class DatabaseClient:
    ...
    def create_bucket(self, bucket, retention_rules=None):
        ...
        try:
            bucket_api.create_bucket(
                bucket_name=bucket, retention_rules=retention_rules, org=self.org
            )
    ...
    def delete_metric_data(self, key=None, tags=None):
        ...
        self.client.delete_api().delete(
            start, stop, predicate, bucket=self.bucket, org=self.org
        )
    ...
    def get_query(
        ...
        if field_name:
            if isinstance(field_name, (list, tuple)):
                field_filter = " or ".join(
                    [f'r._field == "{field}"' for field in field_name]
                )
            else:
