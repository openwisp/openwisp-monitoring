...
.. image:: https://github.com/openwisp/openwisp-monitoring/actions/workflows/ci.yml/badge.svg
    :target: https://github.com/openwisp/openwisp-monitoring/actions/workflows/ci.yml
    :alt: CI build status
