...
*openwisp-monitoring* provides a set of base classes which can be
...
.. note::
    ...
    - For doubts regarding proxy models please refer to `proxy models
      <https://docs.djangoproject.com/en/5.2/topics/db/models/#proxy-models>`_.
...
<https://docs.djangoproject.com/en/5.2/howto/custom-management-commands/>`_.
